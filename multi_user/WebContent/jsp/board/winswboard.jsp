	...
	<div class="contents-framebox" id="contents_id">
		...
		<div class="contents-con-framebox">
			<div class="nav-box">
				...
				<div class="nav-list">
					<img alt="" src="/resource/images/sub/icon_home.png">&nbsp;HOME&nbsp;&nbsp;>&nbsp;&nbsp;다운로드&nbsp;&nbsp;>&nbsp;&nbsp;<b style="color:#000000;">윈도우10</b>
				</div>
				<div class="nav-title">윈도우10</div>
			</div>
			...
			<c:import url="/resource/common/include/paging.jsp" />	
					<div class="btn-zone">
						<ul>
							<li><input type="button" name="srchDescription" class="admin_btn" onclick="javascript:window.location='/bbsWrite.do?bbsid=10027';" value="등록"></li>
						</ul>
					</div>				
		</div>
		<!--content end-->
