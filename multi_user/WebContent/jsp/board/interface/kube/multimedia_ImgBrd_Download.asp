...
'Code here that you want to catch errors from
	...
	If Err.Number <> 0 Then
	   Response.Write "PROC_ERR"
		...
		attatch_Seq = objStream("attatch_Seq") 
		Set RefBoard = dbCon.execute("select attatch_OrgName, attatch_PhyPath from multi_Img_Board_Attatch WHERE attatch_Seq = " & attatch_Seq)
