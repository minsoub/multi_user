									...
									<div class="row-group">
										<form id="frm" name="frm" method="post">
											...
											<dl class="insert_ready">
												...
												<dd style="width: 200px;"><input type="text" id="notice_Title" name="notice_Title" value=""></dd>
											</dl>
											<dl class="insert_ready">
												<dt class="must-option"><label>내용</label></dt>
												<dd><textarea class="textarea-style" rows="10" cols="88" id="notice_Content" name="notice_Content" style="width: 618px;"></textarea></dd>
											</dl>
										</form>
...
function goSubmit(){
	...
	if(progressChk){
		...
		if(confirm('등록하시겠습니까?')){
			$.ajax({
				type : 'post',
				url : '/admin/registNotice.do',
				dataType : 'json',
				data : params,
				success : function(result){
					alert('등록되었습니다.');
					
					$('#frm').append('<input type="hidden" name="notice_Seq" value="'+result+'" />');
