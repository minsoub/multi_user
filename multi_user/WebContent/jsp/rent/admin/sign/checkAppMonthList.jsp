				...
				<div id="tablelist" class="basic-list2" style="margin-top:5px;">
	                <table id="listTable" summary="">
	                    ...
	                    <tbody>
	                        <c:forEach var="monthList" items="${monthList}" varStatus="x">
	                        <tr>
	                        	<td>${cha:todate(monthList.app_month, '-', '3')} ~ ${cha:todate(cha:monthLastDate(monthList.app_month), '-', '3')}</td>
	                        	<td>
	                        		<c:choose>
	                        	...
	                        	<td>
	                        		<c:if test="${SESS_EMPNO == monthList.app_empno1 && monthList.app_datetime1 eq null}">
	                        			<a href="javascript:;" onclick="javascript:funAppProc('${monthList.app_month}','1');" style="text-decoration: underline;">${monthList.app_emp_name1 }</a>
	                        		</c:if>
	                        	...
	                        	<td>
									<c:if test="${SESS_EMPNO == monthList.app_empno2 && monthList.app_datetime2 eq null && monthList.app_datetime1 ne null}">
	                        			<a href="javascript:;" onclick="javascript:funAppProc('${monthList.app_month}','2');" style="text-decoration: underline;">${monthList.app_emp_name2 }</a>
	                        		</c:if>
	                        	...
	                        	<td>
	                        		<c:if test="${SESS_EMPNO == monthList.app_empno3 && monthList.app_datetime3 eq null && monthList.app_datetime2 ne null}">
	                        			<a href="javascript:;" onclick="javascript:funAppProc('${monthList.app_month}','3');" style="text-decoration: underline;">${monthList.app_emp_name3 }</a>
	                        		</c:if>
