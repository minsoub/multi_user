...
<body>
    ...
    <div id="contents" class="learn-frame-area">
        ...
        <div class="contents-con-framebox">
            ...
            <form id="frm" name="frm" action="/admin/recUpdate.do" method="post" onsubmit="return check();">
...
<script type="text/javascript">
    ...
    $(window).load(function() {
        ...
        $("#tbl_equip").on('click', "tr img.equip_alloc", function(e) {
            ...
            var disableEq = "";
            console.log('alloc_equip'+alloc_equip);
            ...
            var cnt = 0;
            $("select[name='mdseq[]'] option:selected[value="+mdseq+"]").each(function(i){
