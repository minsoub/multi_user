	...
	<div id="contents" class="learn-frame-area">
		<div class="contents-framebox" id="contents_id">
			...
			<div class="tabNav sub5">
				<li><a href="javascript:goWrite();" class="active">출력요청</a></li>
										...
										<form id="frm" name="frm" method="post">
											...
											<dl class="insert_ready">
												...
												<dd style="width: 150px;">
													<input type="radio" id="req_type" name="req_type" value="1" <c:if test="${resultData.req_type eq '1'}">checked</c:if>>현수막
													<input type="radio" id="req_type" name="req_type" value="2" <c:if test="${resultData.req_type eq '2'}">checked</c:if>>A0
													<input type="radio" id="req_type" name="req_type" value="3" <c:if test="${resultData.req_type eq '3'}">checked</c:if>>A1
													<input type="radio" id="req_type" name="req_type" value="4" <c:if test="${resultData.req_type eq '4'}">checked</c:if>>A2
													<input type="radio" id="req_type" name="req_type" value="5" <c:if test="${resultData.req_type eq '5'}">checked</c:if>>기타
												</dd>
												<dt class="must-option"><label>출력부수</label></dt>
												<dd style="width: 50px;"><input type="number" id="prt_cnt" name="prt_cnt" value="${resultDetail.prt_cnt}"></dd>
											</dl>	
											<dl class="insert_ready">
												...
												<dd style="width: 100px;"><input type="text" id="prt_size1" name="prt_size1" value="${resultDetail.prt_size1}" readonly maxlength="6" style="width:60px;">cm</dd>
												<dt class="must-option"><label>세로</label></dt>
												<dd style="width: 100px;"><input type="text" id="prt_size2" name="prt_size2" value="${resultDetail.prt_size2}" readonly maxlength="6" style="width:60px;">cm</dd>												
											</dl>																					
