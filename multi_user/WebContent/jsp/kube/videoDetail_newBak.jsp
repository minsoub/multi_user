...
<form name="contentsFrm" id="contentsFrm" method="post">
	<input type="text" name="playTime" id="playTime" value="${elearnUserMap.play_duration_sec eq null ? '0' : elearnUserMap.play_duration_sec}">
	<input type="text" name="videoPath" id="videoPath" value="${videoInfo.pds_log_path}">
	<input type="text" name="channel" id="channel" value="${videoInfo.channel}">
</form>

<%-- e-러닝 제어 관련 입력 값 --%>
<c:set var="eduPercent" value="${elearnUserMap.play_duration_sec * 100 / videoInfo.duration }" />
<input type="text" id="elearnComplete_flag" name="elearnComplete_flag"  value="${elearnUserMap.complete_flag}" />
<input type="hidden" id="elearnComplete_per" name="elearnComplete_per"  value="${eduPercent}" />

<script type="text/javascript">
var gmPlayTime = $('#playTime').val();
var gmEduComplete = false;
