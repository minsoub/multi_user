	                ...
	                <c:if test="${videoInfo.conv_flag == '1'}">
	                 	...
	                 	<noscript>
					         <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%" id="GMPlayer">
					             <param name="movie" value="/resource/common/kube_video2/GMPlayer.swf" />
					             ...
					             <!--[if !IE]>-->     
					             <object type="application/x-shockwave-flash" data="/resource/common/kube_video2/GMPlayer.swf" width="100%" height="100%">
					                 <param name="quality" value="high" />
					                 <param name="bgcolor" value="#ffffff" />
					                 <param name="allowScriptAccess" value="sameDomain" />
					                 <param name="allowFullScreen" value="true" />
...
<link rel="stylesheet" type="text/css" href="/resource/common/kube_video2/history/history.css" />
<script type="text/javascript" src="/resource/common/kube_video2/history/history.js"></script>
<!-- END Browser History required section -->  
<script type="text/javascript" src="/resource/common/kube_video2/swfobject.js"></script>
<script type="text/javascript">
         //<!-- For version detection, set to min. required Flash Player version, or 0 (or 0.0.0), for no version detection. --> 
         var swfVersionStr = "11.1.0";
         //<!-- To use express install, set to playerProductInstall.swf, otherwise the empty string. -->
         var xiSwfUrlStr = "/resource/common/kube_video2/playerProductInstall.swf";
         var flashvars = {};
         var params = {};
         params.quality = "high";
         ...
         swfobject.embedSWF(
             "/resource/common/kube_video2/GMPlayer.swf", "flashContent", 
             "100%", "100%", 
...
function GMPlayerConfig(){
	return { 
		playURL_high  : '<%= Constants.KUBE_UPLOAD_ASP_IP %>${fn:replace(videoInfo.pds_log_path, '.mp4', '_0.mp4')}', // 영상 url
		playURL  : '<%= Constants.KUBE_UPLOAD_ASP_IP %>${videoInfo.pds_log_path}', // 영상 url
		autoPlay : true, // 자동재생설정 ( true or false )  
		logoImage : '<%= Constants.WEB_URL %>/resource/common/kube_video2/image/logo.png', //업체 로고 이미지
