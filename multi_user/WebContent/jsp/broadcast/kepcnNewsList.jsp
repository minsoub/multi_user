	...
	<div class="contents-framebox" id="contents_id">
		...
		<div class="contents-con-framebox">
			<div class="nav-box">
				...
				<div class="nav-list">
					<img alt="" src="/resource/images/sub/icon_home.png">&nbsp;HOME&nbsp;&nbsp;>&nbsp;&nbsp;사내방송&nbsp;&nbsp;>&nbsp;&nbsp;<b style="color:#000000;">KEP-CN NEWS</b>
				</div>
				<div class="nav-title">KEP-CN NEWS</div>
			</div>
			...
			<div class="basic-list">
					<table id="listTable" summary="">
						...
						<tbody>
							<c:forEach var="item" items="${kepcnNewList}" varStatus="status">
							...
							<c:if test="${fn:length(kepcnNewList) == 0}">
				              	<tr>
				              		<!--다운로드 주석
