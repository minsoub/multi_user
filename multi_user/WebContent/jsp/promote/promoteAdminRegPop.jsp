	    ...
	    <div class="searchArea_con" style="margin-top:35px">
	        <fieldset>
	            <div class="search-box">		
	                ...
	                <input type="button" style="cursor: pointer;" class="search_btn" onclick="javascript:funFrmPagingSubmit2(location.href);" value="검색">
	                </div>
	            </div>
	        </fieldset>
	    </div>
	    <div class="basic-list">
	        <table id="listTable" summary="">
	            <caption>게시판 테이블</caption>
	                ...
	                <thead>
	                    <tr>
	                        <th class="no-td">이름</th>
	                        <th class="like-td">사번</th>
	                        <th class="like-td">부서명</th>
	                        <th class="like-td">직급</th>
	                    </tr>
	                </thead>
					<tbody>
...
function funSaAct(obj, empno, g){
	...
	if(confirm($(obj).children().eq(0).text() + '님을 관리자로 등록하시겠습니까?')){
