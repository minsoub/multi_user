		...
		<input type="hidden" id="pageNo" name="pageNo" value="${paging.pageNo }">
			...
			<div class="contents-con-framebox">
				<div class="nav-box">
					...
					<div class="nav-list">
						<img alt="" src="/resource/images/sub/icon_home.png">&nbsp;HOME&nbsp;&nbsp;>&nbsp;&nbsp;KUBE&nbsp;&nbsp;>&nbsp;&nbsp;<b style="color:#000000;">
					...
					<c:if test="${!videoStatus.first && videoStatus.index % 4 == 0}">
		                ...
		                <div class="media-box01" style="float:left; ${videoStatus.index % 4 != 0 ? 'margin-left:13px' : ''}">
		                    <div style="float:left">
		                        ...
		                        <a href="javascript:;" onclick="javascript:funVideoDetail('/kube/watch/${cha:seqEncode(videoList.vi_seq) }', '${videoList.code_seq1 }', '${videoList.code_seq2 }');"><img src="${web_url.concat(videoList.thumb_log_path)}" style="cursor: pointer;" class="imgMaxWidth180" onclick="javascript:funVideoDetail('${cha:seqEncode(videoList.vi_seq)}');" /></a>
		                    </div>                
