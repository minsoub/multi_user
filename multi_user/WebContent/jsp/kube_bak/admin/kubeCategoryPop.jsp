							...
							<legend>화면1</legend>
								<div class="row-group">	                                
	                                <dl class="insert_ready">
										...
										<dt class="must-option" style="width:100px;"><label for="" id="">1차 카테고리</label></dt>
										<dd><input type="text" id="code_desc" name="code_desc" placeholder="ex) 한전News , 교육" value="${code_desc}" style="width:203px"></dd>
									</dl>
									<dl class="insert_ready">
										<dt class="must-option" style="width:100px;"><label for="" id="">카테고리 영문</label></dt>
						...
						<div class="form-step1">
							...
							<legend>화면1</legend>
								<div class="row-group">	                                
	                                        ...
	                                        <fieldset>	
	                                            <div class="form-group">
	                                                <div>
	                                                    <p class="inputDesign">
	                                                    <c:set var="code_desc" value="" />
	                                                    <select name="p_code_seq" style="width:200px">
						                            		<c:forEach var="category" items="${kubeLeftMenu}" varStatus="status">
	                                ...
	                                <dl class="insert_ready">
										<dt class="must-option" style="width:100px;"><label for="" id="">2차 카테고리</label></dt>
							...
							<legend>화면1</legend>
								<div class="row-group">	                                
	                                <dl class="insert_ready">
										...
										<dt class="must-option" style="width:100px;"><label for="" id="">카테고리</label></dt>
