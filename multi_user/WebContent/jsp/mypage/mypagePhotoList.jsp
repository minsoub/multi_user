        ...
        <div class="contents-framebox" id="contents_id">
            ...
            <div class="contents-con-framebox">
                <div class="nav-box">
                    ...
                    <div class="nav-list">
                        <img alt="" src="/resource/images/sub/icon_home.png">&nbsp;HOME&nbsp;&nbsp;>&nbsp;&nbsp;마이페이지&nbsp;&nbsp;>&nbsp;&nbsp;<b style="color:#000000;">사진촬영 신청내역</b>
                    </div>
                    <div class="nav-title">사진촬영 신청내역</div>
                </div>
                ...
                <form id="frm" name="frm" method="post" action="/mypagePhotoList.do">
                    <input type="hidden" name="pageNo" id="pageNo" value="${paging.pageNo }" />
                    <input type="hidden" id="seq"  name="seq" value="0">
                    <input type="hidden" id="mode" name="mode">
                    <input type="hidden" id="bbsid" name="bbsid" value="10028" />
                    ...
                    <div class="basic-list">
                        <table id="listTable" summary="">
                            ...
                            <colgroup>
                                ...
                                <col style="width: 15%" class="like-td">
                                <col style="width: 15%">
                            </colgroup>
                            <thead>
                                <tr>
                                    <th scope="col" class="no-td">번호</th>
                                    <th scope="col" class="ref-td"><span class="sort sort_desc" sortid="-1">제목</span></th>
                            ...
                            <tbody>
                                <c:forEach items="${resultList}" var="item" varStatus="status">
                                    <tr>
                                        ...
                                        <td class="ref-td" onclick="doDetail('${item.seq}');" style="cursor: pointer;">
                                        ${allLength > 15 ? cuttitle.concat('...') : item.subject }
                                        </td>
                                        <td>${item.req_type_nm}</td>
                                        <td class="date-td">${item.prt_req_dt}</td>
                                        <td class="like-td">${item.want_req_dt}</td>
                                        <td><c:choose>
                                        ...
                                        &nbsp;<img alt=""
                                                    ...
                                                    onclick="javascript:btnCancelNo('${item.seq}');">
                                            </c:if></td>
                                    </tr>
                                </c:forEach>
                                <c:if
