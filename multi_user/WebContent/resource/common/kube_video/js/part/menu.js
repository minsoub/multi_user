...
setMenu.prototype.fnSetIndexPage = function(_xml){
  ...
  $(_xml).find("index").each(function() {
    ...
    $(this).children().each(function(_index) {
      ...
      if(_index != 0) $(".indexList").append($('<div class="menu_line" style=""></div>'));
      ...
      fnSetSubButton(mainBtn,mainTitle,_this.lastIndex++,function(){ movePage(mainPage); });
      ...
      $(this).children().each(function() {
        ...
        fnSetSubButton(subBtn,subTitle,_this.lastIndex++,function(){ movePage(subPage); });
      });
    });
  });
}
