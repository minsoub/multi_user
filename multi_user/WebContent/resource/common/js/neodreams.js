...
function popupUserSearch(){
	$.ajax({
	    url : "/commonUserSearch.do", 
	    type: "POST",
        data: {"searchString" : "", "seq":"0"},
	    dataType : "html",  
	    success : function(result){ 
	...
	window.open("/commonUserSearch.do","_userForm","width=600,height=500,scrollbars=yes,resizable=yes");
}
