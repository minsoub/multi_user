...
<c:choose>
    ...
    <c:set var="isGetAdmin" value="${sessionScope.SESS_USER_INFO['rentAdmin']}"></c:set>
        <!-- 컨텐츠제작 -->
        <div>
            <img alt="컨텐츠제작" src="/resource/images/sub/sub_title02.png">
        </div>
        <div>
            <ul>
                <li>
                    ...
                    <c:choose>
                        <c:when test="${param.left_depth_2 eq 1 }"><img alt="" src="/resource/images/sub/sub2_leftmenu_01b.png"></c:when>
                        <c:otherwise><img alt="" src="/resource/images/sub/sub2_leftmenu_01.png"></c:otherwise>
                    </c:choose>
                    </a>
    ...
    <c:when test="${param.left_depth_1 eq 3 }">
        <!-- 전광판게시 -->
        <div>
            <img alt="전광판게시" src="/resource/images/sub/sub_title03.png">
        </div>
        <div>
            <ul>
                <li>
