...
public class HashidsGenerator {
	...
	public HashidsGenerator(String salt) {
		this(salt, 0);
	}

	public HashidsGenerator(String salt, int minHashLength) {
		this(salt, minHashLength, DEFAULT_ALPHABET);
	}

	public HashidsGenerator(String salt, int minHashLength, String alphabet) {
