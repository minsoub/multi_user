...
public class ExcelUtil {
    ...
    private IndexedColors mHeaderColor =  IndexedColors.PALE_BLUE;
    ...
    public ExcelUtil(List<Object> header, List<List<Object>> data) {
        mHeader = header;
        mData = data;
    }
    ...
    public ExcelUtil(InputStream excelFile) {
    	mReadFile = excelFile;
    }
